...
namespace esp8266 {
    ...
    export function readFirebaseValue(deviceName: string): string {
        ...
        // The response contains headers (HTTP/1.1 200 OK...) and body.
        // We simply search for the JSON start character "{" anywhere.
        // This is robust against headers appearing after +IPD
